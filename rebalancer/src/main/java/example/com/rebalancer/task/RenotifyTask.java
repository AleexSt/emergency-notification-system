package example.com.rebalancer.task;

import example.com.rebalancer.client.NotificationClient;
import example.com.rebalancer.dto.kafka.NotificationKafka;
...
import static example.com.rebalancer.model.NotificationType.*;
    ...
    private void renotify() {
        ...
        for (NotificationKafka notification : notificationKafkaList) {
            switch (notification.type()) {
                ...
                default -> throw new IllegalArgumentException("Unknown type: " + notification.type());
            }
        }
    }
}
