package example.com.sender.config;
...
public class KafkaConsumerConfig {
    ...
    public Map<String, Object> consumerConfig() {
        ...
        properties.put(JsonDeserializer.TRUSTED_PACKAGES, "example.com.recipient.dto.kafka");
        properties.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "example.com.sender.dto.kafka.NotificationKafka");
