package example.com.notification.client;

import example.com.notification.dto.response.TemplateHistoryResponse;
import example.com.notification.dto.response.TemplateResponse;
...
@FeignClient(name = "${services.template}", url = "localhost:8080")
