package example.com.security.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import example.com.security.service.JwtService;
import example.com.security.service.MessageSourceService;
import example.com.security.service.TokenService;
...
import example.com.security.dto.response.ErrorResponse;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if(jwt != null && !jwt.isEmpty() && SecurityContextHolder.getContext().getAuthentication() == null){
            try{
                UserDetails userDetail = tokenService.takeUserDetailsFromJwt(jwt);
                if(tokenService.isTokenValid(jwt)){
                    UsernamePasswordAuthenticationToken authenticationToken = createAuthenticationToken(userDetail, request);
